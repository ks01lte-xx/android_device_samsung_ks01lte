    ...
    callback_handlers.on_notify_response = [weak_ptr_this](legacy_hal::transaction_id id,
        ...
        switch (msg.response_type) {
            ...
            case legacy_hal::NAN_GET_CAPABILITIES: {
                ...
                for (const auto& callback : shared_ptr_this->getEventCallbacks()) {
                    if (!callback->notifyCapabilitiesResponse(id, wifiNanStatus, hidl_struct)
                                 .isOk()) {
                        LOG(ERROR) << "Failed to invoke the callback";
                    }
                }
...
Return<void> WifiNanIface::enableRequest_1_4(uint16_t cmd_id, const NanEnableRequest& msg1,
                                             const V1_2::NanConfigRequestSupplemental& msg2,
...
Return<void> WifiNanIface::configRequest_1_4(uint16_t cmd_id, const NanConfigRequest& msg1,
                                             const V1_2::NanConfigRequestSupplemental& msg2,
...
WifiStatus WifiNanIface::enableRequest_1_4Internal(uint16_t cmd_id, const NanEnableRequest& msg1,
                                                   const V1_2::NanConfigRequestSupplemental& msg2) {
    legacy_hal::NanEnableRequest legacy_msg;
    if (!hidl_struct_util::convertHidlNanEnableRequest_1_4ToLegacy(msg1, msg2, &legacy_msg)) {
        return createWifiStatus(WifiStatusCode::ERROR_INVALID_ARGS);
    }
    legacy_hal::wifi_error legacy_status =
...
WifiStatus WifiNanIface::configRequest_1_4Internal(uint16_t cmd_id, const NanConfigRequest& msg1,
                                                   const V1_2::NanConfigRequestSupplemental& msg2) {
    legacy_hal::NanConfigRequest legacy_msg;
    if (!hidl_struct_util::convertHidlNanConfigRequest_1_4ToLegacy(msg1, msg2, &legacy_msg)) {
        return createWifiStatus(WifiStatusCode::ERROR_INVALID_ARGS);
    }
    legacy_hal::wifi_error legacy_status =
