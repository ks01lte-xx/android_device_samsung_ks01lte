...
std::vector<sp<IWifiRttControllerEventCallback>> WifiRttController::getEventCallbacks() {
...
WifiStatus WifiRttController::rangeRequestInternal_1_4(uint32_t cmd_id,
...
std::pair<WifiStatus, RttCapabilities> WifiRttController::getCapabilitiesInternal_1_4() {
    legacy_hal::wifi_error legacy_status;
...
std::pair<WifiStatus, RttResponder> WifiRttController::getResponderInfoInternal_1_4() {
    legacy_hal::wifi_error legacy_status;
