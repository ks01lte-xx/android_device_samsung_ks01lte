...
Return<void> Wifi::registerEventCallback(const sp<IWifiEventCallback>& event_callback,
...
WifiStatus Wifi::registerEventCallbackInternal(const sp<IWifiEventCallback>& event_callback) {
...
WifiStatus Wifi::initializeModeControllerAndLegacyHal() {
    ...
    if (legacy_status != legacy_hal::WIFI_SUCCESS) {
        LOG(ERROR) << "Failed to initialize legacy HAL: " << legacyErrorToString(legacy_status);
